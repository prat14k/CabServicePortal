...
class ViewController: UIViewController {
    ...
    func addGradientLayer(){
        ...
        gradientLayer.colors = [UIColor.rgb(red: 64, green: 224, blue: 208, alpha: 1.0).cgColor , UIColor.rgb(red: 255, green: 140, blue: 0, alpha: 1.0).cgColor , UIColor.rgb(red: 255, green: 0, blue: 128, alpha: 1.0).cgColor]
...
extension ViewController : UITextFieldDelegate {
    ...
    func isEmailValid(email : String) -> Bool {
        ...
        let emailTest = NSPredicate(format: "SELF MATCHES \(emailRegex)", argumentArray: nil)
